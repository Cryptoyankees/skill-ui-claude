...
window.ITINERARIES = [
  ...
  },
  {
    ...
    days: [
      ...
      { day: 9, title: "Tash Rabat → Song-Köl", description: "Route vers Song-Köl et nuit en yourte chez une famille d'éleveurs, au bord du lac d'altitude.", activities: ["Nuit en yourte"], overnight: "Yourte à Song-Köl", icon: "yurt", photo: "images/vallee-suusamyr-alpage-kirghizstan.jpg", photoAlt: "Steppe d'altitude et alpage du Tian Shan" },
