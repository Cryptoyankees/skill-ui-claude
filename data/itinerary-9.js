/*
 * Terres Nomades — itinéraire jour par jour, circuit "Nomade" (9 jours).
...
window.ITINERARY = [
  ...
  { day: 7, icon: 'mountain', title: 'Cap sur Song-Köl', text: "Franchissement des cols du Tian Shan en direction du lac d'altitude de Song-Köl.", photo: false },
  { day: 8, icon: 'yurt', title: 'Lac de Song-Köl', text: "Nuit en yourte chez une famille d'éleveurs, au bord du lac de Song-Köl.", photo: true },
  { day: 9, icon: 'car', title: 'Retour et départ', text: "Redescente vers Bichkek et transfert vers l'aéroport. Fin du séjour.", photo: false },
];
